...
public class Test {
  ...
  /** Calculates the score based on how many questions the user answered correctly */
  ...
  /**
   * Creates an array of questions from a JSON file containing question information
   *
  ...
  public Test retrievePastTest(JSONUserTestObject test) throws Exception {
    ArrayList<JSONUserQuestionObject> userQuestions =
        (ArrayList<JSONUserQuestionObject>) test.getQuestions();
