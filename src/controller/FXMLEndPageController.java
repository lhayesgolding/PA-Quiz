...
public class FXMLEndPageController implements Initializable {
  ...
  @FXML private Button btReviewTest, btViewAccount, btNewTest, btLogOut;
  @FXML private Label lbNumQuestions, lbNumQuestionsCorrect, lbPercentCorrect, lbTestResults;
  @FXML private TextArea reviewTextArea;

  Test test = new Test();

  /**
   * Shows the user the results of the test, with their answers and correct answers
   *
